...
import personalfinance.model.Transactions;
...
public class TransactionAddEditDialog extends AddEditDialog {
    ...
    protected void init() {
        ...
        components.put("LABEL_ARTICLE", new CommonComboBox(SaveData.getInstance().getArticleList().toArray()));
    ...
    protected void setValues() {
        Transactions transaction = (Transactions) c;
    ...
    public Common getCommonFromForm() throws ModelException {
        try {
            ...
            return new Transactions(account, article, Format.fromAmountToNumber(amount), notice, date);
